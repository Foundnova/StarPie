...
/// <c>plugins\registry.json</c>；失败计数与安全模式在 <c>plugins\health.json</c>。理由：
...
public class PluginsPreference
{
    ...
    /// <summary>便携模式：插件目录改用「主程序目录\plugins」。存在 portable.flag 时自动开启。</summary>
    ...
    /// <summary>附加扫描目录（0..N）。开发者调试或插件装在别处时使用。</summary>

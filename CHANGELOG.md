...
## [v1.6.8] - 2026-09-04 (动作画布缩放修复 & 快捷键Pause与搜索 & 临时暂停热键 & 贡献者致谢 & 蜂窝扇迟滞保持 & 手势折叠收纳)
...
3. **新增录制旁「⏸️ 暂停全局热键」状态按钮**：
   - 动作配置面板中的快捷热键录制框旁新增 `[ ⏸️ 暂停全局热键 ]` 切换按钮；
   - 点击可临时挂起全局键盘与鼠标钩子拦截，方便录入复杂快捷键或避免冲突，再次点击即刻恢复并伴随气泡提示。
